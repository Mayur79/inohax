      ...
      <section className="relative z-1">
        <div className="max-w-screen-xl z-10 mx-auto px-4 py-10 sm:py-12 md:py-14 gap-6 text-gray-300">
          <div className="space-y-8 max-w-3xl mx-auto text-center">
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl tracking-tighter font-geist bg-clip-text bg-[linear-gradient(180deg,_#FFF_0%,_rgba(255,_255,_255,_0.00)_202.08%)] text-transparent">
            ...
            <h2 className="text-gray-50 text-lg sm:text-xl bg-gradient-to-b from-[#191929]/40 via-black/70 to-[#191929]/40 p-2 sm:p-4 w-fit mx-auto rounded-md backdrop-blur-3xl">
              <b>Compete in Inohax 1.0 and stand a chance to win a cash prize of INR 10,000!</b>
            </h2>
